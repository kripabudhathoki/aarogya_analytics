...
<body>
            ...
            <div class="row align-items-center">
              <div class="col-12">
                <div class="d-sm-flex align-items-center justify-space-between">
                  <h4 class="mb-4 mb-sm-0 card-title">Material-Datepicker</h4>
          ...
          <div class="card">
            ...
            <div class="card-body">
              <p class="card-subtitle">
                Use
                <mark>
                  <code>.bootstrapMaterialDatePicker</code>
                </mark> to
                create it.
              </p>
              <div class="row">
                <div class="col-12">
                  ...
                  <input type="text" class="form-control" placeholder="2023-06-04" id="mdate" />
                  <label class="form-label mt-3">Default Material Date Timepicker</label>
                  <input type="text" id="date-format" class="form-control" placeholder="Saturday 24 June 2023 - 21:44" />
                </div>
                <div class="col-12">
  ...
  <script src="../assets/js/forms/material-datepicker-init.js"></script>
</body>
