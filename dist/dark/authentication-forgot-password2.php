                    ...
                    <div class="col-lg-11">
                      <div class="card-body">
                        ...
                        <form>
                          ...
                          <a href="../dark/index.html" class="btn btn-dark w-100 py-8 mb-4 rounded-1">Forgot Password</a>
                          <a href="../dark/authentication-login2.html" class="btn bg-primary-subtle text-primary w-100 py-8 mb-4 rounded-1">Back to Login</a>
