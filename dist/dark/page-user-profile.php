                ...
                <div class="col-lg-4">
                  <div class="card shadow-none border">
                    <div class="card-body">
                      ...
                      <p class="card-subtitle">Hello, I am David McMichael. I love making websites and graphics. Lorem
                      ...
                      <div class="vstack gap-3 mt-4">
                        ...
                        <div class="hstack gap-6">
                          ...
                          <h6 class=" mb-0">david@wrappixel.com</h6>
                        </div>
                        <div class="hstack gap-6">
                  ...
                  <div class="card shadow-none border">
                    <div class="card-body">
                      ...
                      <div class="row">
                        <div class="col-4">
                          <img src="../assets/images/profile/user-1.jpg" alt="matdash-img" class="rounded-1 img-fluid mb-9">
                        </div>
                        <div class="col-4">
                          <img src="../assets/images/profile/user-2.jpg" alt="matdash-img" class="rounded-1 img-fluid mb-9">
                        </div>
                        <div class="col-4">
                          <img src="../assets/images/profile/user-3.jpg" alt="matdash-img" class="rounded-1 img-fluid mb-9">
                        </div>
                        <div class="col-4">
                          <img src="../assets/images/profile/user-4.jpg" alt="matdash-img" class="rounded-1 img-fluid mb-9">
                        </div>
                        <div class="col-4">
                          <img src="../assets/images/profile/user-5.jpg" alt="matdash-img" class="rounded-1 img-fluid mb-9">
                        </div>
                        <div class="col-4">
                          <img src="../assets/images/profile/user-6.jpg" alt="matdash-img" class="rounded-1 img-fluid mb-9">
                        </div>
                        <div class="col-4">
                          <img src="../assets/images/profile/user-7.jpg" alt="matdash-img" class="rounded-1 img-fluid mb-6">
                        </div>
                        <div class="col-4">
                          <img src="../assets/images/profile/user-8.jpg" alt="matdash-img" class="rounded-1 img-fluid mb-6">
                        </div>
                        <div class="col-4">
                          <img src="../assets/images/profile/user-1.jpg" alt="matdash-img" class="rounded-1 img-fluid mb-6">
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-lg-8">
                  ...
                  <div class="card">
                    <div class="card-body border-bottom">
                      ...
                      <img src="../assets/images/products/s1.jpg" alt="matdash-img" height="360" class="rounded-4 w-100 object-fit-cover">
                      ...
                      <div class="position-relative">
                        ...
                        <div class="p-4 rounded-2 text-bg-light ms-7">
                          <div class="d-flex align-items-center gap-6 flex-wrap">
                            <img src="../assets/images/profile/user-5.jpg" alt="matdash-img" class="rounded-circle" width="40" height="40">
                  ...
                  <div class="card">
                    <div class="card-body border-bottom">
                      <div class="d-flex align-items-center gap-6 flex-wrap">
                        <img src="../assets/images/profile/user-2.jpg" alt="matdash-img" class="rounded-circle" width="40" height="40">
                      ...
                      <div class="row">
                        <div class="col-sm-6">
                          <img src="../assets/images/products/s2.jpg" alt="matdash-img" class="img-fluid rounded-4 mb-3 mb-sm-0">
                        </div>
                        <div class="col-sm-6">
                          <img src="../assets/images/products/s4.jpg" alt="matdash-img" class="img-fluid rounded-4">
                        </div>
                      </div>
                      <div class="d-flex align-items-center my-3">
                        <div class="d-flex align-items-center gap-2">
            ...
            <div class="tab-pane fade" id="pills-followers" role="tabpanel" aria-labelledby="pills-followers-tab" tabindex="0">
              ...
              <div class="row">
                ...
                <div class=" col-md-6 col-xl-4">
                  <div class="card">
                    <div class="card-body p-4 d-flex align-items-center gap-6 flex-wrap">
                      <img src="../assets/images/profile/user-3.jpg" alt="matdash-img" class="rounded-circle" width="40" height="40">
                      <div>
                ...
                <div class=" col-md-6 col-xl-4">
                  <div class="card">
                    <div class="card-body p-4 d-flex align-items-center gap-6 flex-wrap">
                      <img src="../assets/images/profile/user-4.jpg" alt="matdash-img" class="rounded-circle" width="40" height="40">
                      <div>
                ...
                <div class=" col-md-6 col-xl-4">
                  <div class="card">
                    <div class="card-body p-4 d-flex align-items-center gap-6 flex-wrap">
                      <img src="../assets/images/profile/user-7.jpg" alt="matdash-img" class="rounded-circle" width="40" height="40">
                      <div>
                ...
                <div class=" col-md-6 col-xl-4">
                  <div class="card">
                    <div class="card-body p-4 d-flex align-items-center gap-6 flex-wrap">
                      <img src="../assets/images/profile/user-8.jpg" alt="matdash-img" class="rounded-circle" width="40" height="40">
                      <div>
                ...
                <div class=" col-md-6 col-xl-4">
                  <div class="card">
                    <div class="card-body p-4 d-flex align-items-center gap-6 flex-wrap">
                      <img src="../assets/images/profile/user-9.jpg" alt="matdash-img" class="rounded-circle" width="40" height="40">
                      <div>
                ...
                <div class=" col-md-6 col-xl-4">
                  <div class="card">
                    <div class="card-body p-4 d-flex align-items-center gap-6 flex-wrap">
                      <img src="../assets/images/profile/user-10.jpg" alt="matdash-img" class="rounded-circle" width="40" height="40">
                      <div>
            ...
            <div class="tab-pane fade" id="pills-friends" role="tabpanel" aria-labelledby="pills-friends-tab" tabindex="0">
              ...
              <div class="row">
                <div class="col-sm-6 col-lg-4">
                  <div class="card hover-img">
                    <div class="card-body p-4 text-center border-bottom">
                      <img src="../assets/images/profile/user-1.jpg" alt="matdash-img" class="rounded-circle mb-3" width="80" height="80">
                      <h5 class="fw-semibold mb-0">Betty Adams</h5>
                ...
                <div class="col-sm-6 col-lg-4">
                  <div class="card hover-img">
                    <div class="card-body p-4 text-center border-bottom">
                      <img src="../assets/images/profile/user-2.jpg" alt="matdash-img" class="rounded-circle mb-3" width="80" height="80">
                ...
                <div class="col-sm-6 col-lg-4">
                  <div class="card hover-img">
                    <div class="card-body p-4 text-center border-bottom">
                      <img src="../assets/images/profile/user-3.jpg" alt="matdash-img" class="rounded-circle mb-3" width="80" height="80">
                ...
                <div class="col-sm-6 col-lg-4">
                  <div class="card hover-img">
                    <div class="card-body p-4 text-center border-bottom">
                      <img src="../assets/images/profile/user-4.jpg" alt="matdash-img" class="rounded-circle mb-3" width="80" height="80">
                ...
                <div class="col-sm-6 col-lg-4">
                  <div class="card hover-img">
                    <div class="card-body p-4 text-center border-bottom">
                      <img src="../assets/images/profile/user-5.jpg" alt="matdash-img" class="rounded-circle mb-3" width="80" height="80">
                ...
                <div class="col-sm-6 col-lg-4">
                  <div class="card hover-img">
                    <div class="card-body p-4 text-center border-bottom">
                      <img src="../assets/images/profile/user-6.jpg" alt="matdash-img" class="rounded-circle mb-3" width="80" height="80">
                ...
                <div class="col-sm-6 col-lg-4">
                  <div class="card hover-img">
                    <div class="card-body p-4 text-center border-bottom">
                      <img src="../assets/images/profile/user-7.jpg" alt="matdash-img" class="rounded-circle mb-3" width="80" height="80">
                ...
                <div class="col-sm-6 col-lg-4">
                  <div class="card hover-img">
                    <div class="card-body p-4 text-center border-bottom">
                      <img src="../assets/images/profile/user-8.jpg" alt="matdash-img" class="rounded-circle mb-3" width="80" height="80">
                ...
                <div class="col-sm-6 col-lg-4">
                  <div class="card hover-img">
                    <div class="card-body p-4 text-center border-bottom">
                      <img src="../assets/images/profile/user-9.jpg" alt="matdash-img" class="rounded-circle mb-3" width="80" height="80">
                ...
                <div class="col-sm-6 col-lg-4">
                  <div class="card hover-img">
                    <div class="card-body p-4 text-center border-bottom">
                      <img src="../assets/images/profile/user-10.jpg" alt="matdash-img" class="rounded-circle mb-3" width="80" height="80">
              ...
              <div class="row">
                <div class="col-md-6 col-lg-4">
                  <div class="card hover-img overflow-hidden rounded-2">
                    <div class="card-body p-0">
                      <img src="../assets/images/products/s1.jpg" alt="matdash-img" height="220" class="w-100 object-fit-cover">
                ...
                <div class="col-md-6 col-lg-4">
                  <div class="card hover-img overflow-hidden rounded-2">
                    <div class="card-body p-0">
                      <img src="../assets/images/products/s2.jpg" alt="matdash-img" height="220" class="w-100 object-fit-cover">
                      <div class="p-4 d-flex align-items-center justify-content-between">
                        <div>
                ...
                <div class="col-md-6 col-lg-4">
                  <div class="card hover-img overflow-hidden rounded-2">
                    <div class="card-body p-0">
                      <img src="../assets/images/products/s3.jpg" alt="matdash-img" height="220" class="w-100 object-fit-cover">
                      <div class="p-4 d-flex align-items-center justify-content-between">
                        <div>
                ...
                <div class="col-md-6 col-lg-4">
                  <div class="card hover-img overflow-hidden rounded-2">
                    <div class="card-body p-0">
                      <img src="../assets/images/products/s4.jpg" alt="matdash-img" height="220" class="w-100 object-fit-cover">
                      <div class="p-4 d-flex align-items-center justify-content-between">
                        <div>
                ...
                <div class="col-md-6 col-lg-4">
                  <div class="card hover-img overflow-hidden rounded-2">
                    <div class="card-body p-0">
                      <img src="../assets/images/products/s5.jpg" alt="matdash-img" height="220" class="w-100 object-fit-cover">
                      <div class="p-4 d-flex align-items-center justify-content-between">
                        <div>
                ...
                <div class="col-md-6 col-lg-4">
                  <div class="card hover-img overflow-hidden rounded-2">
                    <div class="card-body p-0">
                      <img src="../assets/images/products/s6.jpg" alt="matdash-img" height="220" class="w-100 object-fit-cover">
                      <div class="p-4 d-flex align-items-center justify-content-between">
                        <div>
                ...
                <div class="col-md-6 col-lg-4">
                  <div class="card hover-img overflow-hidden rounded-2">
                    <div class="card-body p-0">
                      <img src="../assets/images/products/s7.jpg" alt="matdash-img" height="220" class="w-100 object-fit-cover">
                      <div class="p-4 d-flex align-items-center justify-content-between">
                        <div>
                ...
                <div class="col-md-6 col-lg-4">
                  <div class="card hover-img overflow-hidden rounded-2">
                    <div class="card-body p-0">
                      <img src="../assets/images/products/s8.jpg" alt="matdash-img" height="220" class="w-100 object-fit-cover">
                      <div class="p-4 d-flex align-items-center justify-content-between">
                        <div>
                ...
                <div class="col-md-6 col-lg-4">
                  <div class="card hover-img overflow-hidden rounded-2">
                    <div class="card-body p-0">
                      <img src="../assets/images/products/s9.jpg" alt="matdash-img" height="220" class="w-100 object-fit-cover">
                      <div class="p-4 d-flex align-items-center justify-content-between">
                        <div>
                ...
                <div class="col-md-6 col-lg-4">
                  <div class="card hover-img overflow-hidden rounded-2">
                    <div class="card-body p-0">
                      <img src="../assets/images/products/s10.jpg" alt="matdash-img" height="220" class="w-100 object-fit-cover">
                      <div class="p-4 d-flex align-items-center justify-content-between">
                        <div>
                ...
                <div class="col-md-6 col-lg-4">
                  <div class="card hover-img overflow-hidden rounded-2">
                    <div class="card-body p-0">
                      <img src="../assets/images/products/s11.jpg" alt="matdash-img" height="220" class="w-100 object-fit-cover">
                      <div class="p-4 d-flex align-items-center justify-content-between">
                        <div>
                ...
                <div class="col-md-6 col-lg-4">
                  <div class="card hover-img overflow-hidden rounded-2">
                    <div class="card-body p-0">
                      <img src="../assets/images/products/s12.jpg" alt="matdash-img" height="220" class="w-100 object-fit-cover">
                      <div class="p-4 d-flex align-items-center justify-content-between">
                        <div>
