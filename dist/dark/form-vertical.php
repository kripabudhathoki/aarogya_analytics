            ...
            <div class="row align-items-center">
              <div class="col-12">
                <div class="d-sm-flex align-items-center justify-space-between">
                  <h4 class="mb-4 mb-sm-0 card-title">Vertical Form</h4>
                ...
                <div class="card-body p-4">
                  ...
                  <div class="mb-4">
                    ...
                    <div class="input-group">
                      ...
                      <textarea class="form-control p-7 ps-2" name="" id="" cols="20" rows="1" placeholder="Hi, Do you  have a moment to talk Jeo ?"></textarea>
                    </div>
                  </div>
                  <BUtton class="btn btn-primary">Send</BUtton>
                </div>
            ...
            <div class="accordion accordion-flush position-relative overflow-hidden" id="accordionFlushExample">
                  ...
                  <div class="accordion-body px-3 fw-normal">
                    <div class="row">
                      ...
                      <div class="col-12">
                        <div class="mb-4">
                          ...
                          <textarea class="form-control p-7" name="" id="" cols="20" rows="1" placeholder="150, Ring Road"></textarea>
                        </div>
                      </div>
                      <div class="col-lg-6">
                        <div class="mb-4">
                      ...
                      <div class="col-lg-6">
                        <div class="mb-4">
                          ...
                          <input type="text" class="form-control" id="exampleInputlandmark" placeholder="Nr. Wall Street">
                        </div>
                      </div>
                      <div class="col-lg-6">
                        <div class="mb-4">
                    ...
                    <div>
                      ...
                      <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadioHome" value="option1">
                        <label class="form-check-label" for="inlineRadioHome">Home (All day delivery)</label>
                      </div>
                      <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadioOffice" value="option1">
              ...
              <div class="accordion-item mb-3 shadow-none border">
                ...
                <div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
                  <div class="accordion-body px-3 fw-normal">
                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadioStandard" value="option1">
                      <label class="form-check-label" for="inlineRadioStandard">Standard 3-5 Days</label>
                    </div>
                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadioExpress" value="option1">
                      <label class="form-check-label" for="inlineRadioExpress">Express</label>
                    </div>
                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadioOvernight" value="option1">
              ...
              <div class="accordion-item mb-3 shadow-none border rounded-bottom">
                ...
                <div id="flush-collapseThree" class="accordion-collapse collapse" aria-labelledby="flush-headingThree" data-bs-parent="#accordionFlushExample">
                  <div class="accordion-body px-3 fw-normal">
                    <div class="mb-4">
                      <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadioCreditDebitATMCard" value="option1">
                        <label class="form-check-label" for="inlineRadioCreditDebitATMCard">Credit/Debit/ATM
                          Card</label>
                      </div>
                      <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadioCashonDelivery" value="option1">
                    ...
                    <div class="row">
                      <div class="col-lg-8">
                        <div class="mb-4">
                          ...
                          <input type="text" class="form-control" id="exampleInputCardNumber" placeholder="1250 4521 5630 1540">
                        </div>
                        <div class="row">
                          <div class="col-lg-6">
                            <div class="mb-4">
