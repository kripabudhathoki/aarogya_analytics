                    ...
                    <div class="col-lg-11">
                      <div class="card-body">
                        ...
                        <form>
                          ...
                          <a href="../dark/index.html" class="btn btn-dark w-100 py-8 mb-4 rounded-1">Sign Up</a>
                          <div class="d-flex align-items-center">
                            <p class="fs-12 mb-0 fw-medium">Already have an Account?</p>
                            <a class="text-primary fw-bolder ms-2" href="../dark/authentication-login2.html">Sign in Now</a>
                          </div>
                        </form>
                      </div>
                    </div>
