      ...
      <div class="container-fluid">
        <div class="text-center">
          <div class="d-flex align-items-center justify-content-center gap-6">
            ...
            <a href="../dark/frontend-blogpage.php" class="text-muted link-primary fw-bolder fs-3 text-uppercase">
              Blog posts
            </a>
            <iconify-icon icon="solar:alt-arrow-right-outline" class="fs-5 text-muted"></iconify-icon>
        ...
        <div class="mt-5 d-lg-block d-none">
          <img src="../assets/images/frontend-pages/blog-detail-banner.jpg" alt="blog detail banner" class="rounded-3 img-fluid">
        </div>
      </div>
    </section>
    <!-- ------------------------------------- -->
          ...
          <div class="col-lg-8">
            <div class="d-flex flex-column gap-sm-4 gap-3 bg-white rounded-3 p-7">
              ...
              <div class="" id="conclusion">
                ...
                <div class="my-4 px-9 py-6 bg-light-gray border-3 border-start border-primary">
                  <p class="fs-4 mb-0 text-muted">
