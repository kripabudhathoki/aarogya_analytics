  ...
  <div id="main-wrapper">
            ...
            <div class="row align-items-center">
              <div class="col-12">
                <div class="d-sm-flex align-items-center justify-space-between">
                  <h4 class="mb-4 mb-sm-0 card-title">UI Card</h4>
    ...
    &lt;/div&gt;
            ...
            <div class="col-lg-4 col-md-6">
              <!-- Card -->
              <div class="card">
                <img class="card-img-top img-responsive" src="../assets/images/blog/blog-img1.jpg" alt="Card image cap" />
                <div class="card-body">
                  <h4 class="card-title">Card title</h4>
                  <p class="card-text">
                    Some quick example text to build on the card title and make up the bulk of the card's content.
            ...
            <div class="col-lg-4 col-md-6">
              <!-- Card -->
              <div class="card">
                <img class="card-img-top img-responsive" src="../assets/images/blog/blog-img2.jpg" alt="Card image cap" />
                <div class="card-body">
                  <h4 class="card-title">Card title</h4>
                  <p class="card-text">
                    Some quick example text to build on the card title and make up the bulk of the card's content.
            ...
            <div class="col-lg-4 col-md-6">
              <!-- Card -->
              <div class="card">
                <img class="card-img-top img-responsive" src="../assets/images/blog/blog-img3.jpg" alt="Card image cap" />
                <div class="card-body">
                  <h4 class="card-title">Card title</h4>
                  <p class="card-text">
                    Some quick example text to build on the card title and make up the bulk of the card's content.
            ...
            <div class="col-lg-4 col-md-6">
              <!-- Card -->
              <div class="card">
                <img class="card-img-top img-responsive" src="../assets/images/blog/blog-img4.jpg" alt="Card image cap" />
                <div class="card-body">
                  <h4 class="card-title">Card title</h4>
                  <p class="card-text">
                    Some quick example text to build on the card title and make up the bulk of the card's content.
            ...
            <div class="col-lg-4 col-md-6">
              <!-- Card -->
              <div class="card">
                <img class="card-img-top img-responsive" src="../assets/images/blog/blog-img5.jpg" alt="Card image cap" />
                <div class="card-body">
                  <h4 class="card-title">Card title</h4>
                  <p class="card-text">
                    Some quick example text to build on the card title and make up the bulk of the card's content.
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="card-subtitle mb-2 d-flex align-items-center">
                    <i class="ti ti-map-pin me-1 fs-5"></i>Albania
                  </p>
                  <p class="card-text pt-2">
                    Some quick example text to build on the card title and make up the bulk of the card's content.
                  </p>
            ...
            <div class="col-md-6 col-lg-3">
              <div class="card">
                <div class="card-body">
                  <h5 class="card-title">Michael Smith</h5>
                  <p class="card-subtitle mb-2 d-flex align-items-center">
                    <i class="ti ti-map-pin me-1 fs-5"></i>Belize
                  </p>
                  <p class="card-text pt-2">
                    Some quick example text to build on the card title and make up the bulk of the card's content.
                  </p>
            ...
            <div class="col-md-6 col-lg-3">
              <div class="card">
                <div class="card-body">
                  <h5 class="card-title">Maria Hernandez</h5>
                  <p class="card-subtitle mb-2 d-flex align-items-center">
                    <i class="ti ti-map-pin me-1 fs-5"></i>Colombia
                  </p>
                  <p class="card-text pt-2">
                    Some quick example text to build on the card title and make up the bulk of the card's content.
                  </p>
            ...
            <div class="col-md-6 col-lg-3">
              <div class="card">
                <div class="card-body">
                  <h5 class="card-title">David Margaret</h5>
                  <p class="card-subtitle mb-2 d-flex align-items-center">
                    <i class="ti ti-map-pin me-1 fs-5"></i>Egypt
                  </p>
                  <p class="card-text pt-2">
                    Some quick example text to build on the card title and make up the bulk of the card's content.
                  </p>
    ...
    &lt;/div&gt;
            ...
            <div class="col-lg-4 col-md-6">
              <div class="card">
                <img src="../assets/images/blog/blog-img5.jpg" class="card-img-top" alt="matdash-img" />
                <div class="card-body p-10">
                ...
                <div class="card-body d-flex align-items-center p-10 gap-6">
                  <a href="javascript:void(0)" class="link-primary text-muted d-flex align-items-center">
                    <i class="ti ti-heart fs-6 me-1"></i>3
                  </a>
                  <a href="javascript:void(0)" class="link-primary text-muted d-flex align-items-center">
                    <i class="ti ti-message-circle fs-6 me-1"></i>1
                  </a>
                  <div class="ms-auto">
                    <a href="javascript:void(0)" class="link-primary text-muted d-flex align-items-center flex-column flex-sm-row">
                      <i class="ti ti-share fs-6"></i>
                    </a>
                  </div>
                </div>
              </div>
            ...
            <div class="col-lg-4 col-md-6">
              <div class="card">
                <img src="../assets/images/blog/blog-img6.jpg" class="card-img-top" alt="matdash-img" />
                <div class="card-body p-10">
                  <h5 class="card-title fs-5">George Jane</h5>
                  <p class="card-text">
                    Some quick example text to build on the card title and make up the bulk of the card's content.
            ...
            <div class="col-lg-4 col-md-6">
              <div class="card">
                <img src="../assets/images/blog/blog-img8.jpg" class="card-img-top" alt="matdash-img" />
                <div class="card-body p-10">
                  <h5 class="card-title fs-5">Samuel Eliza</h5>
                  <p class="card-text">
                    Some quick example text to build on the card title and make up the bulk of the card's content.
    ...
    &lt;/div&gt;
                ...
                <div class="p-4 d-flex align-items-stretch h-100">
                  <div class="row">
                    ...
                    <div class="col-8 col-md-9 d-flex align-items-center">
                      <div>
                        <a href="javascript:void(0)" class="card-title link-primary fw-semibold text-dark">50% sell on watch</a>
            ...
            <div class="col-md-6 col-lg-4 d-flex align-items-stretch">
              <div class="card w-100 rounded-bottom-0">
                ...
                <div class="progress text-bg-light">
                  <div class="progress-bar progress-bar-striped text-bg-primary progress-bar-animated" style="width: 60%; height: 6px;" role="progressbar">
            ...
            <div class="col-md-6 col-lg-4 d-flex align-items-stretch">
              <div class="card w-100 rounded-bottom-0">
                ...
                <div class="progress text-bg-light">
                  <div class="progress-bar progress-bar-striped text-bg-success progress-bar-animated" style="width: 60%; height: 6px;" role="progressbar">
                    <span class="sr-only">60% Complete</span>
                  </div>
                </div>
              </div>
            ...
            <div class="col-md-6 col-lg-4 d-flex align-items-stretch">
              <div class="card w-100 rounded-bottom-0">
                ...
                <div class="progress text-bg-light">
                  <div class="progress-bar progress-bar-striped text-bg-warning progress-bar-animated" style="width: 60%; height: 6px;" role="progressbar">
                    <span class="sr-only">60% Complete</span>
                  </div>
                </div>
              </div>
            ...
            <div class="col-md-6 col-lg-4 d-flex align-items-stretch">
              <div class="card w-100 rounded-bottom-0">
                ...
                <div class="progress text-bg-light">
                  <div class="progress-bar progress-bar-striped text-bg-danger progress-bar-animated" style="width: 60%; height: 6px;" role="progressbar">
                    <span class="sr-only">60% Complete</span>
                  </div>
                </div>
              </div>
            ...
            <div class="col-md-6 col-lg-4 d-flex align-items-stretch">
              <div class="card w-100 rounded-bottom-0">
                ...
                <div class="progress text-bg-light">
                  <div class="progress-bar progress-bar-striped text-bg-info progress-bar-animated" style="width: 60%; height: 6px;" role="progressbar">
                    <span class="sr-only">60% Complete</span>
                  </div>
                </div>
              </div>
            ...
            <div class="col-md-6 col-lg-4 d-flex align-items-stretch">
              <div class="card w-100 rounded-bottom-0">
                ...
                <div class="progress text-bg-light">
                  <div class="progress-bar progress-bar-striped text-bg-secondary progress-bar-animated" style="width: 60%; height: 6px;" role="progressbar">
                    <span class="sr-only">60% Complete</span>
                  </div>
                </div>
              </div>
            ...
            <div class="col-md-6 col-lg-4">
              <div class="card rounded-3 card-hover">
                ...
                <div class="card-body">
                  <div class="d-flex align-items-center">
                    <span class="flex-shrink-0">
                      <i class="ti ti-brand-google-drive text-info display-6"></i>
                    </span>
                    <div class="ms-4">
            ...
            <div class="col-md-6 col-lg-4">
              <div class="card rounded-3 card-hover">
                ...
                <div class="card-body">
                  <div class="d-flex align-items-center">
                    <span class="flex-shrink-0">
                      <i class="ti ti-folder-down text-danger display-6"></i>
                    </span>
                    <div class="ms-4">
            ...
            <div class="col-md-6 col-lg-4">
              <div class="card rounded-3 card-hover">
                ...
                <div class="card-body">
                  <div class="d-flex align-items-center">
                    <span class="flex-shrink-0">
                      <i class="ti ti-download text-secondary display-6"></i>
                    </span>
                    <div class="ms-4">
            ...
            <div class="col-md-6 col-lg-4">
              <div class="card rounded-3 card-hover">
                ...
                <div class="card-body">
                  <div class="d-flex align-items-center">
                    <span class="flex-shrink-0">
                      <i class="ti ti-folder-star text-primary display-6"></i>
                    </span>
                    <div class="ms-4">
                ...
                <div class="card-body">
                  ...
                  <div class="row mt-3">
                    <div class="col-6 mb-3">
                      <a href="javascript:void(0)" class="text-center rounded border py-3 d-block">
              ...
              <div class="card">
                <div class="card-header text-bg-info d-flex align-items-center">
                  ...
                  <div class="card-actions cursor-pointer ms-auto d-flex button-group">
                    <a href="javascript:void(0)" class="link text-white d-flex align-items-center" data-action="collapse">
                      <i class="ti ti-minus fs-6"></i>
                    </a>
                    <a href="javascript:void(0)" class="mb-0 btn-minimize px-2 cursor-pointer text-white link d-flex align-items-center" data-action="expand">
            ...
            <div class="col-md-6">
              <div class="card">
                <div class="card-header text-bg-primary d-flex align-items-center">
                  <h4 class="card-title text-white mb-0">Title</h4>
                  <div class="card-actions cursor-pointer ms-auto d-flex button-group">
                    <a href="javascript:void(0)" class="link d-flex text-white align-items-center" data-action="collapse">
                      <i class="ti ti-minus fs-6"></i>
                    </a>
                    <a href="javascript:void(0)" class="mb-0 text-white btn-minimize px-2 cursor-pointer link d-flex align-items-center" data-action="expand">
                      <i class="ti ti-arrows-maximize fs-6"></i>
                    </a>
                    <a href="javascript:void(0)" class="mb-0 link text-white d-flex align-items-center pe-0 cursor-pointer" data-action="close">
                      <i class="ti ti-x fs-6"></i>
                    </a>
                  </div>
                </div>
