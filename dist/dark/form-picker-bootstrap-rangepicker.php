        ...
        <div class="container-fluid">
            ...
            <div class="row align-items-center">
              <div class="col-12">
                <div class="d-sm-flex align-items-center justify-space-between">
                  <h4 class="mb-4 mb-sm-0 card-title">Bootstrap-Rangepicker</h4>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <p class="card-subtitle mb-3">
                In these picker, there is separate dropdown for select
              ...
              <p class="card-subtitle mb-3">
                In these picker,automatically apply a new date range as soon
              ...
              <p class="card-subtitle mb-3">
                In these picker,both calender are not linked with each
              ...
              <p class="card-subtitle mb-3">
                In these picker,there is separate dropdown for select direct
              ...
              <p class="card-subtitle mb-3">
                In these picker,there is separate week numbers from start
                date to end date.
              </p>
              <div class="input-group mb-3">
              ...
              <p class="card-subtitle mb-3">
                In these picker,there is separate options like select
              ...
              <p class="card-subtitle mb-3">
                In these picker,with all above options which are mention in
              ...
              <p class="card-subtitle mb-3">
                In these picker,calendar will open on top of the
                form-control.
              </p>
              <div class="input-group mb-3">
