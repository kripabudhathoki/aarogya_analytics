            ...
            <div class="row align-items-center">
              <div class="col-12">
                <div class="d-sm-flex align-items-center justify-space-between">
                  <h4 class="mb-4 mb-sm-0 card-title">Progress Bars</h4>
            ...
            <div class="col-md-4 d-flex align-items-stretch">
              ...
              <div class="card w-100">
                <div class="card-body">
                  ...
                  <div class="progress">
                    <div class="progress-bar text-bg-danger" role="progressbar" style="width: 15%" aria-valuenow="15" aria-valuemin="0" aria-valuemax="100"></div>
                    <div class="progress-bar text-bg-cyan" role="progressbar" style="width: 30%" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100"></div>
                    <div class="progress-bar text-bg-info" role="progressbar" style="width: 20%" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100"></div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-md-6 d-flex align-items-stretch">
              ...
              <div class="card w-100">
                <div class="card-body">
                  ...
                  <div class="progress">
                    <div class="progress-bar progress-bar-striped text-bg-danger" style="width: 60%; height: 6px" role="progressbar"></div>
                  </div>
                  <div class="progress mt-4">
                    <div class="progress-bar progress-bar-striped text-bg-info" style="width: 40%; height: 6px" role="progressbar"></div>
                  </div>
                  <div class="progress mt-4">
                    <div class="progress-bar progress-bar-striped text-bg-success" style="width: 20%; height: 6px" role="progressbar"></div>
                  </div>
                  <div class="progress mt-4">
                    <div class="progress-bar progress-bar-striped text-bg-primary" style="width: 30%; height: 6px" role="progressbar"></div>
                  </div>
                  <div class="progress mt-4">
                    <div class="progress-bar progress-bar-striped text-bg-warning" style="width: 80%; height: 6px" role="progressbar"></div>
                  </div>
                  <div class="progress mt-4">
                    <div class="progress-bar progress-bar-striped text-bg-inverse" style="width: 40%; height: 6px" role="progressbar"></div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-md-6 d-flex align-items-stretch">
              ...
              <div class="card w-100">
                <div class="card-body">
                  ...
                  <div class="progress mt-4">
                    <div class="progress-bar progress-bar-striped text-bg-info progress-bar-animated" role="progressbar" aria-valuenow="45" aria-valuemin="0" aria-valuemax="100" style="width: 45%"></div>
                  </div>
                  <div class="progress mt-4">
                  ...
                  <div class="progress mt-4">
                    <div class="progress-bar progress-bar-striped text-bg-dark progress-bar-animated" role="progressbar" aria-valuenow="67" aria-valuemin="0" aria-valuemax="100" style="width: 67%"></div>
                  </div>
                </div>
              </div>
