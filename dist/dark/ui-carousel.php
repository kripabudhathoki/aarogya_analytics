            ...
            <div class="row align-items-center">
              <div class="col-12">
                <div class="d-sm-flex align-items-center justify-space-between">
                  <h4 class="mb-4 mb-sm-0 card-title">Carousel</h4>
                  ...
                  <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img src="../assets/images/blog/blog-img1.jpg" class="d-block w-100" alt="matdash-img" />
                      </div>
                      <div class="carousel-item">
                        <img src="../assets/images/blog/blog-img2.jpg" class="d-block w-100" alt="matdash-img" />
                      </div>
                      <div class="carousel-item">
                        <img src="../assets/images/blog/blog-img3.jpg" class="d-block w-100" alt="matdash-img" />
                      </div>
                    </div>
                  </div>
                </div>
