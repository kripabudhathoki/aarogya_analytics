...
<head>
  ...
  <title>Aarogya Anaslytics</title>
</head>
              ...
              <div class="row gx-0">
                ...
                <div class="col-xl-6 border-end">
                  <div class="row justify-content-center py-4">
                    <div class="col-lg-11">
                      <div class="card-body">
                        <a href="../dark/index.html" class="text-nowrap logo-img d-block mb-4 w-100">
                        ...
                        <form>
                          ...
                          <a href="../dark/index.php" class="btn btn-dark w-100 py-8 mb-4 rounded-1">Sign In</a>
                          <div class="d-flex align-items-center">
                            <p class="fs-12 mb-0 fw-medium">Don’t have an account yet?</p>
                            <a class="text-primary fw-bolder ms-2" href="../dark/authentication-register2.php">Sign Up Now</a>
                          </div>
                        </form>
                      </div>
                    </div>
                        ...
                        <div class="carousel-inner">
                          <div class="carousel-item active">
                            <div class="d-flex align-items-center justify-content-center w-100 h-100 flex-column gap-9 text-center">
                              <img src="../assets/images/logos/favicon1.png" alt="login-side-img" width="500" class="img-fluid" />
                              <h4 class="mb-0">"Your Health, Your Data, One Secure Platform"</h4>
                              <p class="fs-12 mb-0">Track, monitor, and access your health insights anytime, anywhere.</p>
