            ...
            <div class="row align-items-center">
              <div class="col-12">
                <div class="d-sm-flex align-items-center justify-space-between">
                  <h4 class="mb-4 mb-sm-0 card-title">Tooltips</h4>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="mb-3 card-subtitle">
                    ...
                    <mark>
                      <code>data-bs-toggle="tooltip" title="Default
                        tooltip"</code>
                    </mark>
                  </p>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="mb-3 card-subtitle">
                    Just put this to any tag
                    <mark>
                      <code>data-container="body" title="Popover title"
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <a tabindex="0" class="btn bg-danger-subtle d-inline-flex align-items-center text-danger " role="button" data-bs-toggle="popover" data-bs-trigger="focus" title="Dismissible popover" data-bs-content="And here's some amazing content. It's very engaging. Right?">
                    <i class="ti ti-alert-octagon me-2 fs-4"></i>Dismissible popover
                  </a>
                </div>
              </div>
