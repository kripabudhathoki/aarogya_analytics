            ...
            <div class="row align-items-center">
              <div class="col-12">
                <div class="d-sm-flex align-items-center justify-space-between">
                  <h4 class="mb-4 mb-sm-0 card-title">Floating-Input</h4>
              ...
              <form class="floating-labels mt-4 pt-2">
                ...
                <div class="form-group mb-4">
                  ...
                  <span class="help-block">
                    <small>A block of help text that breaks onto a new line and may extend
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form class="floating-labels mt-4">
                <div class="form-group mb-4">
                  <input type="text" class="form-control input-lg" id="input8" />
                  <span class="bar"></span>
                  <label for="input8">Large Input</label>
                </div>
                <div class="form-group mb-4">
                  <input type="text" class="form-control input-sm" id="input9" />
                  <span class="bar"></span>
