            ...
            <div class="row align-items-center">
              <div class="col-12">
                <div class="d-sm-flex align-items-center justify-space-between">
                  <h4 class="mb-4 mb-sm-0 card-title">Customs Card</h4>
          ...
          <div class="row">
                ...
                <div class="card ">
                  <div class="card-body p-0">
                    ...
                    <div class="p-2 d-block mt-3">
                      <img src="../assets/images/profile/user-5.jpg" width="75" class="rounded-circle img-fluid" />
              ...
              <div class="text-center alert-dismissible fade show p-0 alert card-hover" role="alert">
                <div class="card ">
                  <div class="card-body p-0">
                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    <div class="p-2 d-block mt-3">
                      <img src="../assets/images/profile/user-3.jpg" width="75" class="rounded-circle img-fluid" />
                      <h5 class="card-title mt-3">John Deo</h5>
              ...
              <div class="text-center alert-dismissible fade p-0 show alert card-hover" role="alert">
                <div class="card ">
                  <div class="card-body p-0">
                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    <div class="p-2 d-block mt-3">
                      <img src="../assets/images/profile/user-6.jpg" width="75" class="rounded-circle img-fluid" />
                      <h5 class="card-title mt-3">John Deo</h5>
            ...
            <div class="col-lg-4 col-md-6">
              <div class="card text-center">
                <div class="card-body">
                  <img src="../assets/images/profile/user-3.jpg" class="rounded-1 img-fluid" width="90" />
                  <div class="mt-n2">
                    ...
                    <div class="col-6">
                      <div class="py-2 px-3 text-bg-light rounded-1 d-flex align-items-center">
                        <span class="text-primary">
                          <i class="ti ti-brand-google-photos fs-8"></i>
                        </span>
                        <div class="ms-2 text-start">
            ...
            <div class="col-lg-4 col-md-6">
              <div class="card text-center">
                <div class="card-body">
                  <img src="../assets/images/profile/user-2.jpg" class="rounded-1 img-fluid" width="90" />
                  <div class="mt-n2">
                  ...
                  <div class="d-flex align-items-center mb-3">
                    ...
                    <div class="ms-auto">
                      <a href="javascript:void(0)" class="link-primary text-body-color d-flex align-items-center">
                        <i class="ti ti-message-circle me-1 fs-5"></i> 3
                        Comments
                      </a>
                    </div>
                  </div>
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <div class="d-flex  align-items-center mb-3">
                    ...
                    <div class="ms-auto">
                      <a href="javascript:void(0)" class="link-primary text-body-color d-flex align-items-center">
                        <i class="ti ti-message-circle me-1 fs-5"></i> 16
                        Comments
                      </a>
                    </div>
                  </div>
              ...
              <div class="card">
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-12">
                      <div class="progress">
                        <div class="progress-bar text-bg-success" role="progressbar" style="width: 85%; height: 6px;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="card-body">
                  <div class="d-flex align-items-center justify-content-between">
                    <div>
                      ...
                      <p class="fw-medium text-dark mb-0">Activity </p>
                    </div>
                ...
                <div class="card-body">
                  <div class="d-flex align-items-center justify-content-between">
                    <div>
                      ...
                      <p class="fw-medium text-info mb-0">Top Sales</p>
                    </div>
                    <span class="text-info display-6">
                      <i class="ti ti-chart-bar"></i>
                    </span>
                ...
                <div class="card-body">
                  <div class="d-flex align-items-center justify-content-between">
                    <div>
                      ...
                      <p class="fw-medium text-primary mb-0">Top Feeds</p>
                    </div>
                    <span class="text-primary display-6">
                      <i class="ti ti-rss"></i>
                    </span>
                ...
                <div class="card-body">
                  <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div>
                      ...
                      <p class="fw-medium text-dark mb-0">Variations</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="card-body">
                  <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div>
                      ...
                      <p class="fw-medium text-primary mb-0">Sales</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="card-body">
                  <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div>
                      ...
                      <p class="fw-medium text-success mb-0">Monthly
                        Sales</p>
                    </div>
                  </div>
                </div>
              ...
              <div class="card">
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-12">
                      <div class="progress text-bg-light">
                        <div class="progress-bar text-bg-primary" role="progressbar" style="width: 56%; height: 6px;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="card-body">
                  ...
                  <div class="row text-center text-white mt-7">
                    ...
                    <div class="col-4">
                      ...
                      <p class="mb-0">
                        <i class="ti ti-arrow-down fs-5"></i>
                        -1.06
                      </p>
                    </div>
                    <div class="col-4">
