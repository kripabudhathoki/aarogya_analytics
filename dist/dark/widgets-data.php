        ...
        <div class="container-fluid">
            ...
            <div class="row align-items-center">
              <div class="col-12">
                <div class="d-sm-flex align-items-center justify-space-between">
                  <h4 class="mb-4 mb-sm-0 card-title">Widgets-Data</h4>
          ...
          <div class="row">
            ...
            <div class="col-lg-4 col-md-6">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div class="progress mt-3 text-bg-light">
                    <div class="progress-bar text-bg-info" role="progressbar" style="width: 26%; height: 6px;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                  </div>
                </div>
              </div>
            </div>
            <div class="col-lg-4 col-md-6">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div class="progress mt-3 text-bg-light">
                    <div class="progress-bar text-bg-secondary" role="progressbar" style="width: 26%; height: 6px;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6">
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="progress text-bg-light">
                    <div class="progress-bar text-bg-info" role="progressbar" style="width: 40%; height: 6px;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="card">
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-12">
                      <div class="progress text-bg-light">
                        <div class="progress-bar text-bg-primary" role="progressbar" style="width: 56%; height: 6px;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="card-body">
                  <div class="d-flex align-items-center mb-3">
                    <span class="d-flex align-items-center">
                      <i class="ti ti-calendar me-1 fs-5"></i> 20 May
                      2023
                    </span>
                    <div class="ms-auto">
                      <a href="javascript:void(0)" class="link-primary text-body-color d-flex align-items-center">
                        <i class="ti ti-message-circle me-1 fs-5"></i> 3 Comments
                      </a>
                    </div>
                  </div>
                  <h4 class="card-title">
            ...
            <div class="col-lg-4">
              <div class="card">
                ...
                <div class="card-body">
                  <div class="d-flex  align-items-center mb-3">
                    <span class="d-flex align-items-center">
                      <i class="ti ti-calendar me-1 fs-5"></i> 19 May
                      2023
                    </span>
                    <div class="ms-auto">
                      <a href="javascript:void(0)" class="link-primary text-body-color d-flex align-items-center">
                        <i class="ti ti-message-circle me-1 fs-5"></i> 16 Comments
                      </a>
                    </div>
                  </div>
                  <h4 class="card-title">
              ...
              <div class="card">
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-12">
                      <div class="progress text-bg-light">
                        <div class="progress-bar text-bg-danger" role="progressbar" style="width: 56%; height: 6px;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="card">
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-12">
                      <div class="progress text-bg-light">
                        <div class="progress-bar text-bg-dark" role="progressbar" style="width: 26%; height: 6px;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="col-12">
              <div class="card">
                <div class="position-relative">
                  <img class="card-img-top" src="../assets/images/backgrounds/profilebg.jpg" alt="Card image cap" style="max-height: 450px">
                ...
                <div class="card-body">
                  <div class="d-flex align-items-center">
                    <div>
                      ...
                      <p class="fw-medium text-info mb-0">Feeds</p>
                    </div>
                    <div class="ms-auto">
                      <span class="text-info display-6">
                        <i class="ti ti-file-text"></i>
                ...
                <div class="card-body">
                  <div class="d-flex  align-items-center">
                    <div>
                      ...
                      <p class="fw-medium text-primary mb-0">Invoices</p>
                    </div>
                    <div class="ms-auto">
                      <span class="text-primary display-6">
                        <i class="ti ti-clipboard"></i>
                ...
                <div class="card-body">
                  <div class="d-flex  align-items-center">
                    <div>
                      ...
                      <p class="fw-medium text-success mb-0">Revenue</p>
                    </div>
                    <div class="ms-auto">
                      <span class="text-success display-6">
                ...
                <div class="card-body">
                  <div class="d-flex  align-items-center">
                    <div>
                      ...
                      <p class="fw-medium text-danger mb-0">Sales</p>
                    </div>
                    <div class="ms-auto">
                      <span class="text-danger display-6">
                ...
                <div class="card-body">
                  <div class="d-flex  align-items-center">
                    ...
                    <div class="ms-auto">
                      ...
                      <p class="fw-medium text-danger mb-0">Customers</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card border-start border-info">
                <div class="card-body">
                  <div class="d-flex  align-items-center">
                    ...
                    <div class="ms-auto">
                      <h2 class="fs-7">120</h2>
                      <p class="fw-medium text-info mb-0">Messages</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="card-body">
                  <div class="d-flex  align-items-center">
                    ...
                    <div class="ms-auto">
                      ...
                      <p class="fw-medium text-primary mb-0">Notifications</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="card-body">
                  <div class="d-flex  align-items-center">
                    ...
                    <div class="ms-auto">
                      ...
                      <p class="fw-medium text-success mb-0">Projects</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card border-top border-success">
                <div class="card-body">
                  <div class="d-flex  align-items-center">
                    <div>
                      <h2 class="fs-7">120</h2>
                      <p class="fw-medium text-success mb-0">Locations</p>
                    </div>
                    <div class="ms-auto">
                      <span class="text-success display-6">
                        <i class="ti ti-map"></i>
                ...
                <div class="card-body">
                  <div class="d-flex  align-items-center">
                    <div>
                      ...
                      <p class="fw-medium text-dark mb-0">Activity Pages</p>
                    </div>
                    <div class="ms-auto">
                ...
                <div class="card-body">
                  <div class="d-flex  align-items-center">
                    <div>
                      ...
                      <p class="fw-medium text-info mb-0">Sales</p>
                    </div>
                    <div class="ms-auto">
                      <span class="text-info display-6">
                        <i class="ti ti-chart-bar"></i>
                ...
                <div class="card-body">
                  <div class="d-flex  align-items-center">
                    <div>
                      ...
                      <p class="fw-medium text-primary mb-0">Feeds</p>
                    </div>
                    <div class="ms-auto">
                      <span class="text-primary display-6">
                        <i class="ti ti-rss"></i>
                ...
                <div class="card-body">
                  <div class="d-flex  align-items-center">
                    ...
                    <div class="ms-auto">
                      ...
                      <p class="fw-medium text-dark mb-0">Devices</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card border-end border-info">
                <div class="card-body">
                  <div class="d-flex  align-items-center">
                    ...
                    <div class="ms-auto">
                      <h2 class="fs-7">120</h2>
                      <p class="fw-medium text-info mb-0">Net Income</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="card-body">
                  <div class="d-flex  align-items-center">
                    ...
                    <div class="ms-auto">
                      ...
                      <p class="fw-medium text-primary mb-0">Performance</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card border-end border-success">
                <div class="card-body">
                  <div class="d-flex  align-items-center">
                    ...
                    <div class="ms-auto">
                      <h2 class="fs-7">150</h2>
                      <p class="fw-medium text-success mb-0">Monthly Sales</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-md-6">
              <div class="card-group mb-4">
                ...
                <div class="card text-bg-success border-start border-white" style="--bs-border-opacity: .5;">
                  <div class="card-body text-center text-white">
                    <span class="display-6 d-block mt-3">
            ...
            <div class="col-md-6">
              <div class="card text-white">
                <img class="card-img" src="../assets/images/backgrounds/profilebg.jpg" alt="Card image">
                <div class="card-img-overlay text-white">
                  ...
                  <div class="mt-4">
                    <span>
                      <i class="display-6 ti ti-wind"></i>
                    </span>
            ...
            <div class="col-md-6">
              <div class="card overflow-hidden">
                <div class="card-body text-bg-info text-white text-center p-10">
                  ...
                  <span class="ms-2">
                    <i class="display-6 ti ti-cloud"></i>
                  </span>
                </div>
                ...
                <div class="card-body">
                  ...
                  <div class="row text-center text-white mt-7">
                    <div class="col-4">
                      ...
                      <p class="mb-0">
                        <i class="ti ti-arrow-up fs-5"></i> 0.08
                      </p>
                    </div>
                    <div class="col-4">
                      <span class="fs-3">% 24h</span>
                      <p class="mb-0">
                        <i class="ti ti-arrow-down fs-5"></i> -1.06
                      </p>
                    </div>
                    <div class="col-4">
                      <span class="fs-3">% 7d</span>
                      <p class="mb-0">
                        <i class="ti ti-arrow-up fs-5"></i> -20.10
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div class="card-body">
                  ...
                  <div class="row text-center text-white mt-7">
                    <div class="col-4">
                      <span class="fs-3">% 1h</span>
                      <p class="mb-0">
                        <i class="ti ti-arrow-up fs-5"></i> 0.18
                      </p>
                    </div>
                    <div class="col-4">
                      <span class="fs-3">% 24h</span>
                      <p class="mb-0">
                        <i class="ti ti-arrow-down fs-5"></i> -5.10
                      </p>
                    </div>
                    <div class="col-4">
                      <span class="fs-3">% 7d</span>
                      <p class="mb-0">
                        <i class="ti ti-arrow-up fs-5"></i> -0.10
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div class="card-body">
                  ...
                  <div class="row text-center text-white mt-7">
                    <div class="col-4">
                      <span class="fs-3">% 1h</span>
                      <p class="mb-0">
                        <i class="ti ti-arrow-up fs-5"></i> 1.18
                      </p>
                    </div>
                    <div class="col-4">
                      <span class="fs-3">% 24h</span>
                      <p class="mb-0">
                        <i class="ti ti-arrow-down fs-5"></i> -5.16
                      </p>
                    </div>
                    <div class="col-4">
                      <span class="fs-3">% 7d</span>
                ...
                <div class="card-body">
                  ...
                  <div class="row text-center text-white mt-7">
                    ...
                    <div class="col-4">
                      <span class="fs-3">% 24h</span>
                      <p class="mb-0">
                        <i class="ti ti-arrow-down fs-5"></i> -2.06
                      </p>
                    </div>
                    <div class="col-4">
                      <span class="fs-3">% 7d</span>
                      <p class="mb-0">
                        <i class="ti ti-arrow-up fs-5"></i> -1.10
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div class="card-body">
                  ...
                  <div class="row text-center text-white mt-7">
                    ...
                    <div class="col-4">
                      <span class="fs-3">% 24h</span>
                      <p class="mb-0">
                        <i class="ti ti-arrow-down fs-5"></i> -1.10
                      </p>
                    </div>
                    <div class="col-4">
                      <span class="fs-3">% 7d</span>
                      <p class="mb-0">
                        <i class="ti ti-arrow-up fs-5"></i> -0.20
                      </p>
                    </div>
                  </div>
                </div>
