        ...
        <div class="container-fluid">
            ...
            <div class="row align-items-center">
              <div class="col-12">
                <div class="d-sm-flex align-items-center justify-space-between">
                  <h4 class="mb-4 mb-sm-0 card-title">Chart Apex Line</h4>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div id="chart-line-with-data-label" class="ms-n3"></div>
            </div>
          </div>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div id="chart-line-gradient" class="ms-n3"></div>
            </div>
          </div>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div id="chart-line-real-time" class="ms-n3"></div>
            </div>
          </div>
