            ...
            <div class="row align-items-center">
              <div class="col-12">
                <div class="d-sm-flex align-items-center justify-space-between">
                  <h4 class="mb-4 mb-sm-0 card-title">Tab</h4>
                ...
                <div class="card-body">
                  ...
                  <div class="tab-content border mt-2">
                    <div class="tab-pane active p-3" id="navpill-111" role="tabpanel">
                      <div class="row">
                        <div class="col-md-4">
                          <img src="../assets/images/blog/blog-img2.jpg" alt="matdash-img" class="img-fluid" />
                        </div>
                        <div class="col-md-8">
                          <p>
                    ...
                    <div class="tab-pane p-3" id="navpill-222" role="tabpanel">
                      <div class="row">
                        ...
                        <div class="col-md-4">
                          <img src="../assets/images/blog/blog-img1.jpg" alt="matdash-img" class="img-fluid" />
                        </div>
                      </div>
                    </div>
                    <div class="tab-pane p-3" id="navpill-333" role="tabpanel">
                      <div class="row">
                        <div class="col-md-4">
                          <img src="../assets/images/blog/blog-img3.jpg" alt="matdash-img" class="img-fluid" />
                        </div>
                        <div class="col-md-8">
                          <p>
                            Raw denim you probably haven't heard of them jean
