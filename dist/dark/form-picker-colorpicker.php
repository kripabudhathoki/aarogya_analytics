...
<head>
  ...
  <link rel="stylesheet" href="../assets/libs/@claviska/jquery-minicolors/jquery.minicolors.css">
</head>
...
<body>
            ...
            <div class="row align-items-center">
              <div class="col-12">
                <div class="d-sm-flex align-items-center justify-space-between">
                  <h4 class="mb-4 mb-sm-0 card-title">Colorpicker</h4>
                ...
                <div class="col-md-6">
                  <div class="mb-3">
                    ...
                    <div class="input-group">
                      ...
                      <button class="btn btn-default rounded-end" type="button">
                        Button
                      </button>
  ...
  <script src="../assets/js/plugins/colorpicker-init.js"></script>
</body>
