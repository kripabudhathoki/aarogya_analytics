        ...
        <div class="container-fluid">
            ...
            <div class="row align-items-center">
              <div class="col-12">
                <div class="d-sm-flex align-items-center justify-space-between">
                  <h4 class="mb-4 mb-sm-0 card-title">Select2</h4>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <p class="card-subtitle mb-3">
                ...
                <mark>
                  <code>minimumResultsForSearch</code>
                </mark>
                configuration option. In this example, we use the value
                <mark>
                  <code>Infinity</code>
                </mark> to tell Select2 to
          ...
          <div class="card">
            <div class="card-body">
              ...
              <p class="card-subtitle mb-3">
                ...
                <mark>
                  <code>template-with-flag-icons</code>
                </mark> in the
                select tag.
              </p>
            ...
            <div class="card-body">
              ...
              <div class="btn-toolbar mt-2" role="toolbar" aria-label="Programmatic control">
                <div class="btn-group btn-group-sm" aria-label="Set Select2 option">
                  <button class="js-programmatic-set-val btn bg-primary-subtle text-primary ms-2">
                    Set "New Mexico"
                  </button>
                </div>
                <div class="btn-group btn-group-sm" role="group" aria-label="Open and close">
                  <button class="js-programmatic-open btn bg-primary-subtle text-primary ms-2">
                    Open
                  </button>
                  <button class="js-programmatic-close btn bg-primary-subtle text-primary ms-2">
                    Close
                  </button>
                </div>
                <div class="btn-group btn-group-sm" role="group" aria-label="Initialize and destroy">
                  <button class="js-programmatic-init btn bg-primary-subtle text-primary ms-2">
                    Init
                  </button>
                  <button class="js-programmatic-destroy btn bg-primary-subtle text-primary ms-2">
                    Destroy
                  </button>
                </div>
              </div>
              <h4 class="card-title mt-4">Programmatic Multiple</h4>
              <select class="select2 js-programmatic-multiple form-control" id="programmatic-multiple" multiple="multiple">
                <optgroup label="Alaskan/Hawaiian Time Zone">
                  <option value="AK">Alaska</option>
                  <option value="HI">Hawaii</option>
                </optgroup>
              ...
              <div class="btn-group btn-group-sm mt-2" role="group" aria-label="Programmatic setting and clearing Select2 options">
                <button type="button" class="js-programmatic-multi-set-val btn bg-primary-subtle text-primary">
                  Set to New Mexico and Utah
                </button>
                <button type="button" class="js-programmatic-multi-clear btn bg-primary-subtle text-primary ms-2">
                  Clear
                </button>
              </div>
            </div>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <p class="card-subtitle mb-3">
                To use add class
                <mark>
                  <code>.select2-with-bg</code>
                </mark> with
                <mark>
                  <code>data-bgcolor</code>
                </mark> &amp;
                <mark>
                  <code>data-bgcolor-variation</code>
                </mark>
                attributes for background color of control.
              </p>
              <select class="select2-with-bg form-control" id="bg-select" data-bgcolor="light-primary" data-text-color="text-primary">
                <optgroup label="Alaskan/Hawaiian Time Zone">
                  <option value="AK">Alaska</option>
                  <option value="HI">Hawaii</option>
                </optgroup>
              ...
              <p class="card-subtitle mb-3">
                To use add class
                <mark>
                  <code>.select2-with-menu-bg</code>
                </mark> with
                <mark>
                  <code>data-bgcolor</code>
                </mark> &amp;
              ...
              <select class="select2-with-menu-bg form-control" id="select2-with-menu-bg" data-bgcolor="primary" data-bgcolor-variation="light">
                <optgroup label="Alaskan/Hawaiian Time Zone">
                  <option value="AK">Alaska</option>
                  <option value="HI">Hawaii</option>
                </optgroup>
              ...
              <p class="card-subtitle mb-3">
                To use add class
                <mark>
                  <code>.select2-with-full-bg</code>
                </mark> with
                <mark>
                  <code>data-bgcolor</code>
                </mark> &amp;
              ...
              <select class="select2-with-full-bg form-control w-100" id="select2-with-full-bg" data-bgcolor="light-info" data-text-color="text-info">
                <optgroup label="Alaskan/Hawaiian Time Zone">
                  <option value="AK">Alaska</option>
                  <option value="HI">Hawaii</option>
                </optgroup>
              ...
              <p class="card-subtitle mb-3">
                To use add class
                <mark>
                  <code>.select2-with-border</code>
                </mark> with
                <mark>
                  <code>data-border-color</code>
                </mark> &amp;
                data-border-variation attributes class for Border color of
                control.
              </p>
              <select class="select2-with-border border-info form-control" id="border-with-select2" data-border-color="info" data-border-variation="darken-2" data-text-color="info" data-text-variation="darken-3">
                <optgroup label="Alaskan/Hawaiian Time Zone">
                  <option value="AK">Alaska</option>
                  <option value="HI">Hawaii</option>
                </optgroup>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <select class="select2-with-menu-bg form-control w-100" id="menu-bg-multiple" multiple="multiple" data-bgcolor="light" data-bgcolor-variation="accent-3" data-text-color="white">
                <optgroup label="Alaskan/Hawaiian Time Zone">
                  <option value="AK">Alaska</option>
                  <option value="HI">Hawaii</option>
                </optgroup>
              ...
              <select class="select2-with-full-bg form-control" id="full-bg-multiple" multiple="multiple" data-bgcolor="light-info" data-text-color="white">
                <optgroup label="Alaskan/Hawaiian Time Zone">
                  <option value="AK">Alaska</option>
                  <option value="HI">Hawaii</option>
                </optgroup>
              ...
              <select class="select2-with-border form-control" id="border-multiple" multiple="multiple" data-border-color="info" data-border-variation="accent-2" data-text-color="white">
                <optgroup label="Alaskan/Hawaiian Time Zone">
                  <option value="AK">Alaska</option>
                  <option value="HI">Hawaii</option>
                </optgroup>
