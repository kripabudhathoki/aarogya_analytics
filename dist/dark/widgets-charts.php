            ...
            <div class="row align-items-center">
              <div class="col-12">
                <div class="d-sm-flex align-items-center justify-space-between">
                  <h4 class="mb-4 mb-sm-0 card-title">Charts</h4>
              ...
              <div class="card w-100 position-relative overflow-hidden">
                <div class="card-body p-4">
                  <div class="mb-7 pb-8">
                    ...
                    <h4 class="card-title mt-1">$78,298</h4>
                  </div>
                  <div id="widgest-chart-4" class="ms-n2"></div>
                </div>
              </div>
            </div>
            <div class="col-12">
            ...
            <div class="col-lg-4">
              ...
              <div class="card w-100 position-relative overflow-hidden">
                <div class="card-body">
                  ...
                  <div id="most-visited" class="rounded-bars ms-n3"></div>
              ...
              <div class="card w-100 position-relative overflow-hidden">
                <div class="card-body">
                  <div>
                    ...
                    <div id="yearly-salary" class="ms-n3"></div>
                ...
                <div class="col-md-6 d-flex align-items-stretch">
                  <div class="card w-100 position-relative overflow-hidden">
                    <div class="card-body">
                      ...
                      <div id="projects" class="rounded-bars ms-n2"></div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-lg-4">
              <div class="card w-100 position-relative overflow-hidden">
                <div class="card-body pb-4">
                  ...
                  <div id="revenue-updates" class="rounded-bars ms-n3"></div>
                </div>
              </div>
