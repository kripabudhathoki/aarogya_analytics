                  ...
                  <form>
                    <div class="form-floating mb-3">
                      ...
                      <label>
                        ...
                        <span class="border-start border-warning ps-3">Username</span>
                      </label>
                    </div>
                    <div class="form-floating mb-3">
                      <input type="email" class="form-control border border-warning" placeholder="Email" />
                      <label>
                        <i class="ti ti-mail me-2 fs-4 text-warning"></i>
                        <span class="border-start border-warning ps-3">Email address</span>
                      </label>
                    </div>
                    <div class="form-floating mb-3">
                      <input type="password" class="form-control border border-warning" placeholder="Password" />
                      <label>
                        <i class="ti ti-lock me-2 fs-4 text-warning"></i>
                        <span class="border-start border-warning ps-3">Password</span>
                      </label>
                    </div>
                    <div class="form-floating mb-3">
                      ...
                      <label>
                        <i class="ti ti-lock me-2 fs-4 text-warning"></i>
                        <span class="border-start border-warning ps-3">Confirm Password</span>
                      </label>
                    </div>
                  ...
                  <form>
                    <div class="form-floating mb-3">
                      ...
                      <label>
                        ...
                        <span class="border-start border-primary ps-3">Username</span>
                      </label>
                    </div>
                    <div class="form-floating mb-3">
                  ...
                  <form>
                    <div class="form-floating mb-3">
                      ...
                      <label>
                        ...
                        <span class="border-start border-success ps-3">Username</span>
                      </label>
                    </div>
                    <div class="form-floating mb-3">
                    ...
                    <div class="form-floating mb-3">
                      ...
                      <label>
                        <i class="ti ti-lock me-2 fs-4 text-success"></i>
                        <span class="border-start border-success ps-3">Password</span>
                      </label>
                    </div>
                    <div class="form-floating mb-3">
                      ...
                      <label>
                        <i class="ti ti-lock me-2 fs-4 text-success"></i>
                        <span class="border-start border-success ps-3">Confirm Password</span>
                      </label>
                    </div>
                ...
                <form class="form-horizontal">
                  ...
                  <div class="mb-3">
                    ...
                    <span class="help-block">
                      <small>A block of help text that breaks onto a new line and
