            ...
            <div class="row align-items-center">
              <div class="col-12">
                <div class="d-sm-flex align-items-center justify-space-between">
                  <h4 class="mb-4 mb-sm-0 card-title">Offcanvas</h4>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="d-flex gap-6 flex-wrap">
                <a class="btn bg-primary-subtle text-primary" data-bs-toggle="offcanvas" href="#example1" role="button" aria-controls="example1">
                  Offcanvas with href
                </a>
                <button class="btn bg-info-subtle text-info" type="button" data-bs-toggle="offcanvas" data-bs-target="#example2" aria-controls="example2">
                ...
                <button class="btn bg-secondary-subtle text-secondary" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasScrolling" aria-controls="offcanvasScrolling">
                  Enable body scrolling
                </button>
                <button class="btn bg-success-subtle text-success" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasWithBackdrop" aria-controls="offcanvasWithBackdrop">
                  Enable backdrop (default)
                </button>
                <button class="btn bg-primary-subtle text-primary" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasWithBothOptions" aria-controls="offcanvasWithBothOptions">
