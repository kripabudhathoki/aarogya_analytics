            ...
            <div class="row align-items-center">
              <div class="col-12">
                <div class="d-sm-flex align-items-center justify-space-between">
                  <h4 class="mb-4 mb-sm-0 card-title">Dropdowns</h4>
              ...
              <div class="card w-100">
                <div class="card-body">
                  ...
                  <div class="d-flex flex-wrap gap-6">
                    <!-- Example single danger button -->
                    <div class="btn-group">
                      <button class="btn bg-danger-subtle text-danger dropdown-toggle" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false">
                        Action
                      </button>
                      <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        <li>
                    ...
                    <!-- Example single danger button -->
                    <div class="btn-group">
                      <button class="btn bg-info-subtle text-info dropdown-toggle" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false">
                        Action
                      </button>
                      <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        <li>
                    ...
                    <!-- Example single danger button -->
                    <div class="btn-group">
                      <button class="btn bg-warning-subtle text-warning dropdown-toggle" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false">
                        Action
                      </button>
                      <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        <li>
                    ...
                    <!-- Example single danger button -->
                    <div class="btn-group">
                      <button class="btn bg-success-subtle text-success dropdown-toggle" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false">
                        Action
                      </button>
                      <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        <li>
                    ...
                    <!-- Example single danger button -->
                    <div class="btn-group">
                      <button class="btn bg-secondary-subtle text-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false">
                        Action
                      </button>
                      <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        <li>
              ...
              <div class="card w-100">
                <div class="card-body">
                  ...
                  <p class="mb-3 card-subtitle">
                    Use a <mark>
                      <code>.btn-lg</code>
                    </mark> classes to create
                    instant button
                  </p>
                  <div class="d-flex flex-wrap gap-6">
                    <div class="btn-group">
                      <button class="btn bg-secondary-subtle text-secondary  btn-lg dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        Large button
                      </button>
                      <ul class="dropdown-menu">
                        <li>
                    ...
                    <div class="btn-group">
                      <button class="btn bg-secondary-subtle text-secondary  btn-lg me-0" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        Large button
                      </button>
            ...
            <div class="col-lg-6 d-flex align-items-stretch">
              ...
              <div class="card w-100">
                <div class="card-body">
                  ...
                  <div class="d-flex flex-wrap gap-6">
                    <div class="btn-group">
                      <button class="btn bg-secondary-subtle text-secondary  btn-sm dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        Small button
                      </button>
                      <ul class="dropdown-menu">
                        <li>
                    ...
                    <div class="btn-group">
                      <button class="btn bg-secondary-subtle text-secondary  btn-sm" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        Small button
                      </button>
              ...
              <div class="card w-100">
                <div class="card-body">
                  ...
                  <div class="d-flex flex-wrap gap-6">
                    ...
                    <div class="btn-group">
                      <button class="me-0 btn bg-secondary-subtle text-secondary btn-lg" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        Dark Dropdown
                      </button>
                      <button type="button" class="btn btn-lg bg-secondary-subtle text-secondary dropdown-toggle dropdown-toggle-split" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="sr-only">Toggle Dropdown</span>
              ...
              <div class="card w-100">
                <div class="card-body">
                  ...
                  <p class="mb-3 card-subtitle">
                    ...
                    <mark>
                      <code>animated flipInX, flipInY, lightSpeedIn, slideInUp
                      </code>
                    </mark>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="d-flex flex-wrap gap-6">
                    ...
                    <div class="btn-group">
                      <button type="button" class="me-0 btn bg-secondary-subtle text-secondary dropdown-toggle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        Left-aligned menu
                      </button>
            ...
            <div class="col-md-6">
              <div class="card">
                <div class="card-body table-responsive">
                  ...
                  <div class="btn-group">
                    <button type="button" class="btn bg-secondary-subtle text-secondary dropdown-toggle" data-bs-toggle="dropdown" data-display="static" aria-haspopup="true" aria-expanded="false">
                ...
                <div class="card-body button-group">
                  ...
                  <div class="d-flex">
                    <div class="dropdown me-1">
                      <button type="button" class="btn bg-secondary-subtle text-secondary dropdown-toggle" id="dropdownMenuOffset" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-offset="10,20">
                        Offset
                      </button>
