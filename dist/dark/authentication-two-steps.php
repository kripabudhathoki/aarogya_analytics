          ...
          <div class="col-lg-6 col-xl-5 col-xxl-4">
            <div class="authentication-login min-vh-100 bg-body row justify-content-center justify-content-lg-start align-items-center p-5">
              <div class="col-12 auth-card">
                <a href="../dark/index.html" class="text-nowrap logo-img d-block w-100">
                  <img src="../assets/images/logos/logo-icon.svg" class="dark-logo" alt="Logo-Dark" />
                </a>
                <h2 class="mb-2 mt-4 fs-7 fw-bolder">Two Steps Verification</h2>
                <p class="mb-9">We sent a verification code to your mobile. Enter the code from the mobile in the field
                  below.</p>
