                  ...
                  <div class="row justify-content-center py-4">
                    <div class="col-lg-11">
                      <div class="card-body">
                        ...
                        <p class="text-muted">We sent a verification code to your mobile. Enter the code from the mobile
                        ...
                        <form>
                          ...
                          <a href="../dark/index.html" class="btn btn-dark w-100 py-8 mb-4 rounded-1">Verify My
                            Account</a>
                          <div class="d-flex align-items-center">
                            <p class="fs-12 mb-0 fw-medium">Didn't get the code?</p>
                            <a class="text-primary fw-semibold ms-2" href="javascript:void(0)">Resend</a>
                          </div>
                        ...
                        <div class="carousel-inner">
                          <div class="carousel-item active">
                            <div class="d-flex align-items-center justify-content-center w-100 h-100 flex-column gap-9 text-center">
                              <img src="../assets/images/backgrounds/login-side.png" alt="login-side-img" width="200" class="img-fluid" />
