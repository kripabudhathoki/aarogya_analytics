        ...
        <div class="container-fluid">
            ...
            <div class="row align-items-center">
              <div class="col-12">
                <div class="d-sm-flex align-items-center justify-space-between">
                  <h4 class="mb-4 mb-sm-0 card-title">Chart Apex Area</h4>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="ms-n2" id="chart-area-basic"></div>
            </div>
          </div>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="ms-n3" id="chart-area-spline"></div>
            </div>
          </div>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="ms-n3" id="chart-area-datetime"></div>
            </div>
          </div>
