            ...
            <div class="row align-items-center">
              <div class="col-12">
                <div class="d-sm-flex align-items-center justify-space-between">
                  <h4 class="mb-4 mb-sm-0 card-title">Cards</h4>
          ...
          <div class="row">
            <div class="col-lg-4">
              <div class="card">
                ...
                <div class="card-body p-4">
                  ...
                  <a class="d-block my-4 fs-5 text-dark fw-semibold link-primary" href="">As yen tumbles, gadget-loving Japan goes
            ...
            <div class="col-lg-4">
              <div class="card">
                ...
                <div class="card-body p-4">
                  ...
                  <a class="d-block my-4 fs-5 text-dark fw-semibold link-primary" href="">Intel loses bid to revive antitrust case
            ...
            <div class="col-lg-4">
              <div class="card">
                ...
                <div class="card-body p-4">
                  ...
                  <a class="d-block my-4 fs-5 text-dark fw-semibold link-primary" href="">COVID outbreak deepens as more lockdowns
                    loom in China</a>
                  <div class="d-flex align-items-center gap-4">
                    <div class="d-flex align-items-center gap-2">
            ...
            <div class="col-md-6 col-lg-3">
              <div class="card overflow-hidden">
                <div class="position-relative">
                  <a href="javascript:void(0)">
                    <img src="../assets/images/products/s4.jpg" class="card-img-top" alt="matdash-img">
                  </a>
                ...
                <div class="card-body p-4">
                  ...
                  <div class="d-flex align-items-center justify-content-between">
                    <div class="d-flex align-items-center gap-2">
                      <h5 class="fw-semibold fs-4 mb-0">$285</h5>
            ...
            <div class="col-md-6 col-lg-3">
              <div class="card overflow-hidden">
                <div class="position-relative">
                  <a href="javascript:void(0)">
                    <img src="../assets/images/products/s5.jpg" class="card-img-top" alt="matdash-img">
                  </a>
                  <a href="javascript:void(0)" class="btn btn-primary rounded-circle p-2 d-flex align-items-center justify-content-center position-absolute bottom-0 end-0 me-3 mb-n3">
                    <i class="ti ti-basket"></i>
                  </a>
                ...
                <div class="card-body p-4">
                  ...
                  <div class="d-flex align-items-center justify-content-between">
                    <div class="d-flex align-items-center gap-2">
                      <h5 class="fw-semibold fs-4 mb-0">$900</h5>
            ...
            <div class="col-md-6 col-lg-3">
              <div class="card overflow-hidden">
                <div class="position-relative">
                  <a href="javascript:void(0)">
                    <img src="../assets/images/products/s7.jpg" class="card-img-top" alt="matdash-img">
                  </a>
                  <a href="javascript:void(0)" class="btn btn-primary rounded-circle p-2 d-flex align-items-center justify-content-center position-absolute bottom-0 end-0 me-3 mb-n3">
                    <i class="ti ti-basket"></i>
                  </a>
                ...
                <div class="card-body p-4">
                  ...
                  <div class="d-flex align-items-center justify-content-between">
                    <div class="d-flex align-items-center gap-2">
                      <h5 class="fw-semibold fs-4 mb-0">$200</h5>
            ...
            <div class="col-md-6 col-lg-3">
              <div class="card overflow-hidden">
                <div class="position-relative">
                  <a href="javascript:void(0)">
                    <img src="../assets/images/products/s11.jpg" class="card-img-top" alt="matdash-img">
                  </a>
                  <a href="javascript:void(0)" class="btn btn-primary rounded-circle p-2 d-flex align-items-center justify-content-center position-absolute bottom-0 end-0 me-3 mb-n3">
                    <i class="ti ti-basket"></i>
                  </a>
                ...
                <div class="card-body p-4">
                  ...
                  <div class="d-flex align-items-center justify-content-between">
                    <div class="d-flex align-items-center gap-2">
                      <h5 class="fw-semibold fs-4 mb-0">$345</h5>
                ...
                <div class="row">
                    ...
                    <ul class="d-flex align-items-center justify-content-between mb-0 list-unstyled px-3 pb-7">
                      <li>
                        <a href="javascript:void(0)" class="text-muted p-2">
                          <i class="ti ti-player-skip-back fs-5"></i>
                        </a>
                      </li>
                      <li>
                      ...
                      <li>
                        <a href="javascript:void(0)" class="text-muted p-2">
                          <i class="ti ti-player-skip-forward fs-5"></i>
                        </a>
                      </li>
                    </ul>
                  </div>
                  <div class="col-6 ps-0">
                    <div class="position-relative w-100 h-100">
                      <img src="../assets/images/blog/blog-img5.jpg" class="w-100 h-100 rounded-0" alt="matdash-img">
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-md-4">
              <div class="card overflow-hidden">
                <div class="row">
                  ...
                  <div class="col-6 ps-0">
                    <div class="position-relative w-100 h-100">
                      <img src="../assets/images/blog/blog-img4.jpg" class="w-100 h-100 rounded-0" alt="matdash-img">
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-md-4">
              <div class="card overflow-hidden">
                <div class="row">
                  ...
                  <div class="col-6 ps-0">
                    <div class="position-relative w-100 h-100">
                      <img src="../assets/images/blog/blog-img3.jpg" class="w-100 h-100 rounded-0" alt="matdash-img">
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card">
                <div class="card-body p-4 d-flex align-items-center gap-3">
                  ...
                  <div>
                    ...
                    <span class="fs-2 d-flex align-items-center">
                      <i class="ti ti-map-pin text-dark fs-3 me-1"></i>Bulgaria
                    </span>
                  </div>
                  <button class="btn btn-primary py-1 px-2 ms-auto">Follow</button>
                </div>
              ...
              <div class="card">
                <div class="card-body p-4 d-flex align-items-center gap-3">
                  ...
                  <div>
                    ...
                    <span class="fs-2 d-flex align-items-center">
                      <i class="ti ti-map-pin text-dark fs-3 me-1"></i>Nepal
                    </span>
                  </div>
                  <button class="btn btn-primary py-1 px-2 ms-auto">Follow</button>
                </div>
            ...
            <div class="col-sm-6 col-lg-3">
              <div class="card">
                <div class="card-body p-4">
                  <img src="../assets/images/profile/user-11.jpg" alt="matdash-img" class="img-fluid rounded-circle mb-4" width="80" height="80">
            ...
            <div class="col-sm-6 col-lg-3">
              <div class="card">
                <div class="card-body p-4">
                  <img src="../assets/images/profile/user-2.jpg" alt="matdash-img" class="img-fluid rounded-circle mb-4" width="80" height="80">
            ...
            <div class="col-sm-6 col-lg-3">
              <div class="card">
                <div class="card-body p-4">
                  <img src="../assets/images/profile/user-3.jpg" alt="matdash-img" class="img-fluid rounded-circle mb-4" width="80" height="80">
            ...
            <div class="col-sm-6 col-lg-3">
              <div class="card">
                <div class="card-body p-4">
                  <img src="../assets/images/profile/user-4.jpg" alt="matdash-img" class="img-fluid rounded-circle mb-4" width="80" height="80">
                ...
                <div class="card-body p-4">
                  ...
                  <div class="d-flex align-items-center gap-3 pb-3 mb-3 border-bottom">
                    ...
                    <div class="position-relative w-100">
                      <div class="d-flex align-items-center justify-content-between">
                        <h6 class="mb-0 fw-semibold fs-4">Sound</h6>
                        <span>45%</span>
                      </div>
              ...
              <div class="card">
                <div class="card-body p-4">
                  <div class="d-flex align-items-center justify-content-between mb-6">
                    <h6 class="mb-0 fw-semibold fs-4 mb-0">Andrew Grant</h6>
                    <i class="ti ti-gift text-info fs-6"></i>
                  </div>
                  <img src="../assets/images/products/s1.jpg" alt="matdash-img" class="card-img w-100 object-fit-cover mb-4" height="160">
            ...
            <div class="col-md-4">
              <div class="card">
                <div class="card-body p-4">
                  <div class="d-flex align-items-center justify-content-between mb-6">
                    <h6 class="mb-0 fw-semibold fs-4 mb-0">Leo Pratt</h6>
                    <i class="ti ti-gift text-info fs-6"></i>
                  </div>
                  <img src="../assets/images/products/s2.jpg" alt="matdash-img" class="card-img w-100 object-fit-cover mb-4" height="160">
                  <button class="btn btn-primary w-100 fw-normal py-8">Gift to Friend ($50.00)</button>
                </div>
              </div>
            </div>
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-4">
                      <div class="d-flex">
                        <div class="p-8 bg-primary-subtle rounded-1 d-flex align-items-center justify-content-center me-6">
                          <img src="../assets/images/svgs/icon-paypal.svg" alt="matdash-img" class="img-fluid" width="24" height="24">
                        </div>
                        <div>
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-4">
                      <div class="d-flex">
                        <div class="p-8 bg-success-subtle rounded-1 d-flex align-items-center justify-content-center me-6">
                          <img src="../assets/images/svgs/icon-office-bag.svg" alt="matdash-img" class="img-fluid" width="24" height="24">
                        </div>
                        <div>
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-4">
                      <div class="d-flex">
                        <div class="p-8 bg-warning-subtle rounded-1 d-flex align-items-center justify-content-center me-6">
                          <img src="../assets/images/svgs/icon-master-card.svg" alt="matdash-img" class="img-fluid" width="24" height="24">
                        </div>
                        <div>
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-7 pb-8">
                      <div class="d-flex">
                        <div class="p-8 bg-danger-subtle rounded-1 d-flex align-items-center justify-content-center me-6">
                          <img src="../assets/images/svgs/icon-pie.svg" alt="matdash-img" class="img-fluid" width="24" height="24">
                        </div>
                        <div>
                ...
                <div class="card-body p-4">
                  ...
                  <div class="position-relative">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                      <div class="d-flex">
                        <div class="p-8 bg-primary-subtle rounded-1 d-flex align-items-center justify-content-center me-6">
                          <img src="../assets/images/svgs/icon-map-pin.svg" alt="matdash-img" class="img-fluid" width="24" height="24">
                        </div>
                        <div>
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-4">
                      <div class="d-flex">
                        <div class="p-8 bg-info-subtle rounded-1 d-flex align-items-center justify-content-center me-6">
                          <img src="../assets/images/svgs/icon-database.svg" alt="matdash-img" class="img-fluid" width="24" height="24">
                        </div>
                        <div>
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-4">
                      <div class="d-flex">
                        <div class="p-8 bg-warning-subtle rounded-1 d-flex align-items-center justify-content-center me-6">
                          <img src="../assets/images/svgs/icon-phone.svg" alt="matdash-img" class="img-fluid" width="24" height="24">
                        </div>
                        <div>
                    ...
                    <div class="d-flex align-items-center justify-content-between">
                      <div class="d-flex">
                        <div class="p-8 bg-success-subtle rounded-1 d-flex align-items-center justify-content-center me-6">
                          <img src="../assets/images/svgs/icon-mail.svg" alt="matdash-img" class="img-fluid" width="24" height="24">
                        </div>
                        <div>
                      ...
                      <h6 class="mb-0 fw-semibold text-muted">20 mins</h6>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="card-body">
                  ...
                  <ul class="timeline-widget mb-0 position-relative mb-n5">
                    ...
                    <li class="timeline-item d-flex position-relative overflow-hidden">
                      ...
                      <div class="timeline-desc fs-12 text-dark-light mt-n6 fw-medium">New sale
                    ...
                    <li class="timeline-item d-flex position-relative overflow-hidden">
                      ...
                      <div class="timeline-desc fs-12 text-dark-light mt-n6 fw-medium">Project meeting
                      </div>
                    </li>
                    <li class="timeline-item d-flex position-relative overflow-hidden">
                      <div class="timeline-time mt-n6 text-muted flex-shrink-0 text-end">09:46
